...
<html lang="en">
      ...
      <center>
        <div class="centered">
          <form role="form" autocomplete="off">
              <input type="text" id="searchText" class="searchBox" placeholder="Enter Vehicle id"  required>
  ...
  <?php }else{
    ...
    $("#aboutbtn").on("click", function(){
        showAlert("Automobile surveillance and tracking using Radio Frequency Identification (RFID) and Blockchain");
    });
